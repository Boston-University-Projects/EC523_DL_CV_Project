...
PROJECT_NAME="yolor_p6_zerowaste_augmented_v11_150_with_updated_metrics"
SCC_GROUP='dl523'
...
# Give job a name
#$ -N yolor_p6_zerowaste_augmented_v11_150_with_updated_metrics

# Combine output and error files into a single file
#$ -j y

# Specify the output file name
#$ -o /projectnb/dl523/projects/RWD/EC523_DL_CV_Project/roboflow-ai/log/yolor_p6_zerowaste_augmented_v11_150_with_updated_metrics_04-30-2022.qlog
