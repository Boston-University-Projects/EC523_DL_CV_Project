...
PROJECT_NAME="real_yolov4_p6_zerowaste_zu"
SCC_GROUP='dl523'
...
# Give job a name
#$ -N real_yolov4_p6_zerowaste

# Combine output and error files into a single file
#$ -j y

# Specify the output file name
#$ -o /projectnb/dl523/students/dong760/roboflow-ai/log/real_yolov4-p6-zerowaste_zu_04-07-2022.qlog
...
python train.py --batch-size 16 --img 640 640 --data zero-waste-1/data.yaml --cfg cfg/yolov4-p6.cfg --weights weights/yolov4-p6.weights  --device 0 --name yolov4-p6-300-ep_$TIMESTAM --epochs 300

python test.py --conf-thres 0.001  --img-size 640 --batch 16 --device 0 --data zero-waste-1/data.yaml --cfg cfg/yolov4-p6.cfg --weights weights/best.pt --task test --names zero-waste-1/zero-waste.names --verbose
