...
from utils.plots import plot_images, output_to_target, plot_results
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='yolor/weights/yolor_p6.p', help='model.pt path(s)')
    ...
    parser.add_argument('--names', type=str, default='yolor/data/zerowaste.names', help='*.cfg path')
    parser.add_argument('--gt_json_dir', default='../zero-waste-10/test/_annotations.coco.json', help='Where is the ground truth annotation json file locaed?')
