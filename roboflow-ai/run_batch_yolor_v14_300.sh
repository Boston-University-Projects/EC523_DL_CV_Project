...
PROJECT_NAME="yolor_p6_zerowaste_v14_1280x1280_300"
SCC_GROUP='dl523'
...
# Give job a name
#$ -N yolor_p6_zerowaste_v14_1280x1280_300

# Combine output and error files into a single file
#$ -j y

# Specify the output file name
#$ -o /projectnb/dl523/projects/RWD/EC523_DL_CV_Project/roboflow-ai/log/yolor_p6_zerowaste_v14_1280x1280_300_05-05-2022.qlog
...
echo "==========================> Start Training"
DATASET_DIR='../zero-waste-14'
cd /projectnb/dl523/projects/RWD/EC523_DL_CV_Project/roboflow-ai/yolor

python train.py --batch-size 16 --img 1280 1280 --data $DATASET_DIR/data.yaml --cfg cfg/yolor_p6.cfg --weights weights/yolor_p6.pt --device 3 --name yolor_p6_$TIMESTAMP --hyp data/hyp.scratch.1280.yaml --epochs 300 --augment True

python test.py --conf-thres 0.0 --img 1280 --batch 16 --device 3 --data $DATASET_DIR/data.yaml --cfg cfg/yolor_p6.cfg --weights runs/train/yolor_p6_$TIMESTAMP/weights/best_overall.pt --task test --names data/zerowaste.names --verbose --save-json --save-conf --save-txt --gt_json_dir $DATASET_DIR/test/_annotations.coco.json
