...
PROJECT_NAME="yolor_p6_zerowaste_augmented_v12_150_with_updated_metrics"
SCC_GROUP='dl523'
...
# Give job a name
#$ -N yolor_p6_zerowaste_augmented_v12_150_with_updated_metrics

# Combine output and error files into a single file
#$ -j y

# Specify the output file name
#$ -o /projectnb/dl523/projects/RWD/EC523_DL_CV_Project/roboflow-ai/log/yolor_p6_zerowaste_augmented_v12_150_with_updated_metrics_04-30-2022.qlog
...
python train.py --batch-size 16 --img 640 640 --data ../zero-waste-12/data.yaml --cfg cfg/yolor_p6.cfg --weights weights/yolor_p6.pt --device 3 --name yolor_p6_$TIMESTAMP --hyp data/hyp.scratch.1280.yaml --epochs 150 --augment True

python test.py --conf-thres 0.0 --img 640 --batch 16 --device 3 --data ../zero-waste-10/data.yaml --cfg cfg/yolor_p6.cfg --weights runs/train/yolor_p6_$TIMESTAMP/weights/best_overall.pt --task test --names data/zerowaste.names --verbose --save-json --save-conf --save-txt --gt_json_dir ../zero-waste-12/test/_annotations.coco.json
