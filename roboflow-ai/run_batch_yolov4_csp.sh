...
PROJECT_NAME="yolov4_csp_zerowaste"
SCC_GROUP='dl523'
...
# Give job a name
#$ -N yolov4_csp_zerowaste

# Combine output and error files into a single file
#$ -j y

# Specify the output file name
#$ -o /projectnb/dl523/students/dong760/roboflow-ai/log/yolov4_csp_zerowaste_04-07-2022.qlog
...
python yolor/train.py --batch-size 32 --img 640 640 --data zero-waste-1/data.yaml --cfg yolor/cfg/yolov4_csp.cfg --weights 'yolor/weights/yolov4.weights' --device 0 --name yolov4_csp_$TIMESTAMP --hyp 'yolor/data/hyp.scratch.1280.yaml' --epochs 300
yolov4_csp
...
python yolor/test.py --conf-thres 0.5 --conf 0.001 --iou 0.65 --img 640 --batch 32 --device 0 --data zero-waste-1/data.yaml --cfg yolor/cfg/yolov4_csp.cfg --weights "runs/train/yolov4_csp_$TIMESTAMP/weights/best_overall.pt" --task test --names yolor/data/zerowaste.names --verbose --save-json --save-conf --save-txt
